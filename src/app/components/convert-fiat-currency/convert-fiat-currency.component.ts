...
import { configWidgetPriceFix, configWidgetPrice, Fiats } from "../../components/config-chart/data-display";
...
@Component({
  selector: 'app-convert-fiat-currency',
  templateUrl: './convert-fiat-currency.component.html',
  styleUrls: ['./convert-fiat-currency.component.scss']
})
export class ConvertFiatCurrencyComponent implements OnInit {

  public fiats = Fiats;
  public selLeftCoin: SelOption = this.fiats[0];
  public selRightCoin: SelOption = this.fiats[152];
  public flags: any = {
    showTicketTab: true,
    showTicket: true,
    heightChart: 245
