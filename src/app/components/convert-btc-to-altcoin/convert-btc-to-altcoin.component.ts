...
@Component({
  selector: 'app-convert-btc-to-altcoin',
  templateUrl: './convert-btc-to-altcoin.component.html',
  styleUrls: ['./convert-btc-to-altcoin.component.scss']
})
export class ConvertBtcToAltcoinComponent implements OnInit, AfterViewInit {

  public cryptos = CrytoStandard;
  public selLeftCoin: SelOption = this.cryptos[0];
  public selRightCoin: SelOption = this.cryptos[4];
  public flags: any = {
    showTicketTab: true,
    showTicket: true,
    heightChart: 245
